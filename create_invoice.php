				...
				<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
					<span class="form-inline">
						...
						<div class="form-group">
							<form action="">
							<input type="hidden" value="<?php echo $_SESSION['userid']; ?>" class="form-control" name="userId">  
							<input formaction="payment.php"  data-loading-text="Payment Proceeding..." type="submit" name="Payment btn" value="Proceed Payment" class="btn btn-success submit_btn invoice-save-btm">						
